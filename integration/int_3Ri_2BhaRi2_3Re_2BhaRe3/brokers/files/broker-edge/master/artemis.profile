# This configuration file artemis.profile.jinja2 has been generated at 2019-04-18 15:36 by amqcfg tool
#
...
ARTEMIS_HOME='/opt/apache-artemis-2.7.0'
...
ARTEMIS_INSTANCE_URI='file:/opt/broker1'
ARTEMIS_INSTANCE_ETC_URI='file:/opt/broker1/etc/'

# Cluster Properties: Used to pass arguments to ActiveMQ Artemis which can be referenced in broker.xml
#ARTEMIS_CLUSTER_PROPS="-Dactivemq.remoting.default.port=61617 -Dactivemq.remoting.amqp.port=5673 -Dactivemq.remoting.stomp.port=61614 -Dactivemq.remoting.hornetq.port=5446"

# Java Opts
JAVA_ARGS="-XX:+PrintClassHistogram -XX:+UseG1GC -Xms512M -Xmx2G -Xloggc:gc.log -XX:+HeapDumpOnOutOfMemoryError -Dhawtio.realm=activemq -Dhawtio.offline="true" -Dhawtio.role=amq -Dhawtio.rolePrincipalClasses=org.apache.activemq.artemis.spi.core.security.jaas.RolePrincipal -Djolokia.policyLocation=${ARTEMIS_INSTANCE_ETC_URI}jolokia-access.xml"
